...
<nav class="navbar navbar-inverse" data-spy="affix" data-offset-top="197">
    ...
    <tr>
        ...
        <tr>
            ...
            <img src="baccarat.png" width=300px height=600px class="borderimage" onMouseover="borderit(this,'white')" onMouseout="borderit(this,'black')">
            </a>
            </td>
            ...
            <img src="dice.PNG" width=300px height=600px class="borderimage" onMouseover="borderit(this,'white')" onMouseout="borderit(this,'black')">
            </a>
            </td>
            <td width=100px height=600px style="border-radius:30px">
            </td>
            <td width=300px height=600px style="border-radius:30px">
            <a href="index.php?user=<?php  $user = $_GET['user']; echo $user;?>">
            <img src="bird.PNG" width=300px height=600px class="borderimage" onMouseover="borderit(this,'white')" onMouseout="borderit(this,'black')">
            </a>
            </td>
        </tr>
    </table>
