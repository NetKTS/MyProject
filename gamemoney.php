...
echo "<table align='left' border='0'> <tr height='200' bgcolor=''><td width='70'></td> <td width='100' align='center'> <font size ='6' style='font-family: Chonburi' color='white'>ห้อง $room</font> </td> <td width='400'  bgcolor='' align='center'> 
...
echo 'timeleft =10;';
    ...
    if($show !=0){
        ...
        echo 'youc =2}';
        //echo "alert('hello room');";
        echo    "window.location.href = 'gamemoney.php?user=$user&s='+youc +'&room=$room'";
        echo ';';
    }
    if($show ==0) {
        ...
        echo    "window.location.href = 'gamemoney.php?user=$user&s='+ youc+'&room=$room'";
        echo ';';
    }else {echo    "window.location.href = 'gamemoney.php?user=$user&room=$room' ;";
        echo 'var use = 2;';
    }
echo  '}';
echo '},1000);';
