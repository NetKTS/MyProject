...
$showornot = true;
    ...
    echo "<table align='left' border='0'> <tr height='200' bgcolor=''><td width='70'></td> <td width='100' align='center'> <font size ='6' style='font-family: Chonburi' color='white'>ห้อง 300</font> </td> <td width='400'  bgcolor='' align='center'> 
...
echo 'timeleft =10;';
    ...
    if($show !=0){
        ...
        echo    "window.location.href = 'dice300.php?user=$user&s=' + youc";
        echo ';';
    }
    if($show ==0) {
        ...
        echo    "window.location.href = 'dice300.php?user=$user&s=' + youc";
        echo ';';
    }else {echo    "window.location.href = 'dice300.php?user=$user' ;";
        echo 'var use = 2;';
    }
echo  '}';
echo '},1000);';
