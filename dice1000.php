...
<style>
    body {
        background-image: url("backgroundhp2.jpg")
    }
...
<?php
    ...
    <a href="Home3.php?user=<?php  $user = $_GET['user']; echo $user;?>">
...
$showornot = true;
    ...
    echo "<table align='left' border='0'> <tr height='200' bgcolor=''><td width='70'></td> <td width='100' align='center'> <font size ='6' style='font-family: Chonburi' color='white'>ห้อง 1000</font> </td> <td width='400'  bgcolor='' align='center'> 
    ...
    <img src='plus.png' height='42' width='42'></a> MONEY : <font size='7' color='yellow' id='moneynow'> $money </font> </td> <td width='181'></td></tr> </table>";
 // RED   RED   RED   RED   RED   RED   RED   RED   RED   RED   
echo '<table align="left">';
echo '<tr bgcolor="lime" >';
echo "<td colspan='3' style='border-radius: 10px;font-family: Chonburi'align='center'><font size='5' color='black'>HIGH LOW</font></td>";
echo '</tr>';
...
echo '<tr>';    
    ...
    $scorered=0; 
    while($red){
        echo "<td><img src='dice/$randca[$c].png' style='border-radius: 20px;'>  </td>";
...
<tr bgcolor="lime"><td colspan="3" style="border-radius: 10px" align="center">
     <font size=5 color="black" style="font-family: Chonburi"><?php  echo "$scorered"; ?></font> 
    </td></tr>
</table>
...
echo '<td colspan="3" align="center" ><font size="5" color="white">BLUE</font></td>';
echo '</tr>';
echo '<tr>'; */   

    ?>
    
     <font size=5 color="white"><?php $scoreblue =  isset($scoreblue)?"0":"0"; $scoreblue = $scoreblue % 10; ?></font> 
    </td></tr>
</table>
<?php
...
echo "var mes ='' ;";
echo "var whowin = 0 ;";
echo 'if(scorered>11) {mes = "Wait"; whowin = 1;}';
echo "else if(scorered==11) { mes = 'Wait...';";

    
echo "
    
     whowin = 3;}";
echo 'else {mes = "Wait..."; whowin = 2;}';
if($show == 0){
    echo "mes = 'Random';";}
echo 'document.getElementById("showwin").innerHTML = mes;';
$whowin=0;
if($scorered>11) $whowin = 1;
else if($scorered == 11) $whowin = 3;
else {$whowin = 2;
//echo 'alert("hello");';
...
$sqlre = "INSERT INTO details (Username,Result,Money,Game,Time) VALUES ('$user','$winorlose','$pay','high-low','$timetext') ";
...
echo 'timeleft =10;';
    ...
    if($show !=0){
        ...
        echo    "window.location.href = 'dice1000.php?user=$user&s=' + youc";
        echo ';';
    }
    if($show ==0) {
        ...
        echo    "window.location.href = 'dice1000.php?user=$user&s=' + youc";
        echo ';';
    }else {echo    "window.location.href = 'dice1000.php?user=$user' ;";
        echo 'var use = 2;';
    }
echo  '}';
echo '},1000);';
...
<table align="center" >
    <tr height="250">
        <td width="400" style="border-radius: 20px" id="cred" onclick="choose('red')" bgcolor="red" align="center"><font size="10" style="font-family: Chonburi" color="white"> HIGH<br>x1!</font></td>
        <td width="100"></td>
        <td width="400" style="border-radius: 20px" id="cgreen" onclick="choose('green')" bgcolor="green"align="center"><font size="10" style="font-family: Chonburi" color="white"> 11<br>x5!</font></td>
        <td width="100"></td>
        <td width="400" style="border-radius: 20px" id="cblue" onclick="choose('blue')" bgcolor="blue"align="center"><font size="10" style="font-family: Chonburi" color="white"> LOW<br>x1!</font></td>
    </tr>
</table>
<?php
    echo "<script>";
